...
from model import User, PasswordResetToken, Vendor, Event, Booking , Review, Preferences, Favorites, eventtiming, Inquiry, ExtraFacility, Transaction, BookingExtraFacility
import secrets
...
#         event = Event.query.filter_by(id=event_id).first()
#         extra_facilities = event.extra_facilities
#         subtotal = event_hours * event.rate
#         subtotal += extra_facility_cost
...
#             db.session.add(booking)
#             db.session.flush()  # flush is used to generate booking.id
...
#                         # Create and save BookingExtraFacility record
